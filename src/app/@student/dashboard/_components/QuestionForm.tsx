...
import AnsowerQuiz from './answer-quiz'
...
export default function QuestionsForm({ questions }: QuestionsFormProps) {
    ...
    // Mutation
    const { isPending, checkQuestions, data } = useCheckQuestions();
    // Variables
            ...
            <div className="content flex flex-col gap-6 ">
                ...
                <header className="flex flex-col gap-7">
                    <div className="flex gap-7 justify-center items-center">
                        {/* Question number */}
                        <p className={`text-primary text-sm grow text-start `}>Question {step + 1} of {questions.length}</p>

                        {/* Duration */}
                        <div className="p-1 flex gap-2 items-center">
                            <ExamDuration
                                duration={questions[1].exam.duration}
                            />
                        </div>
                    </div>
                    {/* navigation steps */}
                ...
                <Form {...form} >
                    <form onSubmit={form.handleSubmit(onSubmit)} className="grow flex flex-col">
                                                            ...
                                                            <div className='flex gap-[80px] items-center justify-center'>
                                                                ...
                                                                <div className="relative w-40 h-40">
                                                                    ...
                                                                    <svg className="w-full h-full" viewBox="0 0 100 100">
                                                                        ...
                                                                        {/* Progress circle */}
                                                                        <circle className="stroke-primary fill-none transition-all duration-500 ease-in-out" strokeWidth={6} strokeLinecap="round" strokeDasharray="251.2" strokeDashoffset="100.48" cx={50} cy={50} r={40} transform="rotate(-90 50 50)" />
                                                                    </svg>
                                                                    {/* Percentage text */}
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-auto">
                            ...
                            {/* Next */}
                            {step >= questions.length ? <Button onClick={() => {
